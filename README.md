...
| `miz 抽奖` | 迷子的小游戏：从素材库里随机抽一款 B 站礼物，用合并转发附上抽奖揭晓和它的展示效果；礼物按价值分五档稀有度（🌱 普通 / ⭐ 稀有 / ✨ 史诗 / 💎 传说 / 👑 神话），越贵越难抽到；同一个 QQ 号每天只能抽一次，记录在 PostgreSQL 的 `gift_lottery_daily_draws` 表里，跨群也算同一次。 |
