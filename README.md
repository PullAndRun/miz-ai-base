...
| `miz vtb list/subscribe/unsubscribe ...` | 查看或维护本群订阅；`list` 会标出各主播开播时是否 `@全体成员`；需要群管理员或订阅白名单权限。 |
| `miz vtb atall enable/disable <主播昵称>` | 开启或关闭该主播开播通知的 `@全体成员`；需要先订阅该主播，并需要群管理员或订阅白名单权限。 |
